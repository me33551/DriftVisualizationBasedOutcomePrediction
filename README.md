...
<ul>
  ...
  <li>Install the julia dependencies defined in the environment "MyDependencies" - follow the guide available on https://pkgdocs.julialang.org/v1/environments/#Using-someone-else's-project</li>
</ul>
